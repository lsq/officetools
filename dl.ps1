...
wget.exe -c -t 3 https://www.7-zip.org/a/7z1900-x64.exe
.\7z1900-x64.exe
.\wget.exe -c -t 3 ftp://ftp.info-zip.org/pub/infozip/win32/unz600xn.exe
.\unz600xn.exe -o
.\wget.exe -c -t 3 -d --header="User-Agent: Mozilla/5.0 (Windows NT 6.0) AppleWebKit/537.11 (KHTML, like Gecko) Chrome/23.0.1271.97 Safari/537.11" --header="Referer: https://curl.haxx.se/windows/dl-7.67.0_4/" https://curl.haxx.se/windows/dl-7.67.0_4/curl-7.67.0_4-win64-mingw.zip
